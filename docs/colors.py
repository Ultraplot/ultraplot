...
# palettes. You can use :func::func:`~ultraplot.demos.show_colors` to generate a table of these
...
# :func::func:`~ultraplot.demos.show_colors`. The filtering algorithm also cleans up similar
# names -- for example, ``'reddish'`` and ``'reddy'`` are changed to ``'red'``.
# You can adjust the filtering algorithm by calling :func::func:`~ultraplot.config.register_colors`
...
# ----------------
#
# UltraPlot provides the top-level :func::func:`~ultraplot.utils.set_alpha`,
# :func::func:`~ultraplot.utils.set_hue`, :func::func:`~ultraplot.utils.set_saturation`,
# :func::func:`~ultraplot.utils.set_luminance`, :func::func:`~ultraplot.utils.shift_hue`,
# :func::func:`~ultraplot.utils.scale_saturation`, and :func::func:`~ultraplot.utils.scale_luminance`
...
# to use it for some arbitrary plot element. Use the :func::func:`~ultraplot.utils.to_rgb` or
# :func::func:`~ultraplot.utils.to_rgba` functions to retrieve the RGB or RGBA channel values.
...
# or an arbitrary parent directory (see :func::func:`~ultraplot.config.Configurator.local_folders`).
# After adding the file, call :func::func:`~ultraplot.config.register_colors` or restart your python
# session. You can also manually pass file paths, dictionaries, ``name=color``
# keyword arguments to :func::func:`~ultraplot.config.register_colors`. Each color
