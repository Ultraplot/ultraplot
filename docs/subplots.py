...
# :func::func:`~ultraplot.axes.Axes.number` assigned to each subplot.
# If you add subplots one-by-one with :func::func:`~ultraplot.figure.Figure.add_subplot`, you can
# manually specify the number with the `number` keyword. By default, the subplot number
# is incremented by ``1`` each time you call :func::func:`~ultraplot.figure.Figure.add_subplot`.
# If you draw all of your subplots at once with :func::func:`~ultraplot.figure.Figure.add_subplots`,
...
# `~ultraplot.gridspec.SubplotGrid` returned by :func::func:`~ultraplot.figure.Figure.add_subplots`).
#
# To turn on "a-b-c" labels, set :rcraw:`abc` to ``True`` or pass ``abc=True``
# to :func::func:`~ultraplot.axes.Axes.format` (see :ref:`the format command <ug_format>`
# for details). To change the label style, set :rcraw:`abc` to e.g. ``'A.'`` or
# pass e.g. ``abc='A.'`` to :func::func:`~ultraplot.axes.Axes.format`. You can also modify
...
# :func::func:`~ultraplot.figure.Figure.gridspec`. The "reference" subplot is the subplot whose
# :func::func:`~ultraplot.axes.Axes.number` matches the `refnum` that was passed to
...
# the :func::func:`~ultraplot.figure.Figure.gridspec` geometry.
...
#      :ref:`geographic projection <ug_geo>`, :func::func:`~ultraplot.axes.PlotAxes.imshow`
#      plot, or :func::func:`~ultraplot.axes.PlotAxes.heatmap` plot), then this is used as
...
#      :func::func:`~ultraplot.figure.Figure.add_subplot` or passing `ncols` or `nrows` to
#      :func::func:`~ultraplot.figure.Figure.add_subplots`) the keyword arguments `refaspect`,
#      `refwidth`, and `refheight` effectively apply to every subplot in the
#      figure -- not just the reference subplot.
#    * The physical widths of UltraPlot :func::func:`~ultraplot.axes.Axes.colorbar`\ s and
#      :func::func:`~ultraplot.axes.Axes.panel`\ s are always independent of the figure size.
...
# :ref:`unit string <ug_units>` interpreted by :func::func:`~ultraplot.utils.units`.
...
#    for subplots generated one-by-one with :func::func:`~ultraplot.figure.Figure.add_subplot`
#    rather than :func::func:`~ultraplot.figure.Figure.subplots`. It is controlled by the `sharex`
...
# the :func::func:`~ultraplot.axes.Axes.colorbar` and :func::func:`~ultraplot.axes.Axes.panel` widths;
# various :func::func:`~ultraplot.axes.Axes.legend` spacing and padding arguments; various
# :func::func:`~ultraplot.axes.Axes.format` font size and padding arguments; the line width and
# marker size arguments passed to `~ultraplot.axes.PlotAxes` commands; and all
# applicable :func::func:`~ultraplot.config.rc` settings, e.g. :rcraw:`subplots.refwidth`,
# :rcraw:`legend.columnspacing`, and :rcraw:`axes.labelpad`. This feature is
# powered by the physical units engine :func::func:`~ultraplot.utils.units`.
#
