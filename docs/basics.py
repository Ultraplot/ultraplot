...
# UltraPlot command :func::func:`~ultraplot.ui.subplots` simply calls :class::func:`~ultraplot.ui.figure`
# followed by :func:`ultraplot.figure.Figure.add_subplots`.
#
# * With no arguments, :func::func:`~ultraplot.figure.Figure.add_subplots` returns a subplot
...
#
# * With no arguments, :func::func:`~ultraplot.figure.Figure.add_subplot` returns a subplot
#   generated from a 1-row, 1-column `~ultraplot.gridspec.GridSpec`.
...
#   with the geometry implied by previous :func::func:`~ultraplot.figure.Figure.add_subplot` calls.
# * With a :class:`~matplotlib.gridspec.SubplotSpec` generated by indexing a
#   :class:`ultraplot.gridspec.GridSpec`, :func::func:`~ultraplot.figure.Figure.add_subplot` returns a
#   subplot at the corresponding location. Note that unlike matplotlib, only
#   one :func::func:`~ultraplot.figure.Figure.gridspec` can be used with each figure.
#
# As in matplotlib, to save figures, use :func:`~matplotlib.figure.Figure.savefig` (or its
# shorthand :func::func:`~ultraplot.figure.Figure.save`). User paths in the filename are expanded
...
# -----------------
#
# If you create subplots all-at-once with e.g. :func::func:`~ultraplot.ui.subplots`,
