...
# :func:`~matplotlib.pyplot`, `~ultraplot.ui.subplot` creates a figure and a single
...
# UltraPlot command :func:`~ultraplot.ui.subplots` simply calls :class:`~ultraplot.ui.figure`
