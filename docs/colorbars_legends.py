...
#   :func::func:`~ultraplot.axes.Axes.colorbar` can draw both "outer" colorbars when you request
...
#   with various :func::func:`~ultraplot.axes.Axes.colorbar` keywords.

# :func::func:`~ultraplot.axes.Axes.colorbar` and :func::func:`~ultraplot.axes.Axes.legend` also both accept
...
# or ``legend='b'``) to the plotting command (e.g., :func::func:`~ultraplot.axes.PlotAxes.plot`
# or :func::func:`~ultraplot.axes.PlotAxes.contour`). To pass keyword arguments to the colorbar
# and legend commands, use the `legend_kw` and `colorbar_kw` arguments (e.g.,
# ``legend_kw={'ncol': 3}``). Note that :func::func:`~ultraplot.axes.Axes.colorbar` can also
# build colorbars from lists of arbitrary matplotlib artists, for example the
# lines generated by :func::func:`~ultraplot.axes.PlotAxes.plot` or :func::func:`~ultraplot.axes.PlotAxes.line`
...
# of the :func::func:`~ultraplot.figure.Figure.gridspec` rather than the figure.
...
#   keyword with :ref:`1D commands <ug_1dplots>` like :func::func:`~ultraplot.axes.PlotAxes.plot`.
...
# See :func::func:`~ultraplot.axes.Axes.colorbar` for details.
...
#   the `label` keyword to a contouring command (e.g., :func::func:`~ultraplot.axes.PlotAxes.contour`
#   or :func::func:`~ultraplot.axes.PlotAxes.contourf`).
...
#   `~matplotlib.lines.Line2D`\ s returned by :func::func:`~ultraplot.axes.PlotAxes.plot`,
#   `~matplotlib.container.BarContainer`\ s returned by :func::func:`~ultraplot.axes.PlotAxes.bar`,
#   and `~matplotlib.collections.PolyCollection`\ s
#   returned by :func::func:`~ultraplot.axes.PlotAxes.fill_between`.
...
# (e.g., :func::func:`~ultraplot.axes.PlotAxes.plot` or :func::func:`~ultraplot.axes.PlotAxes.scatter` handles)
