...
docstring._snippet_manager["axes.colorbar_args"] = UltraColorbar._args_docstring
docstring._snippet_manager["axes.colorbar_kwargs"] = UltraColorbar._kwargs_docstring
...
class Axes(maxes.Axes):
    ...
    def _add_colorbar(
        ...
        **kwargs,
        ...
        self._register_guide("colorbar", colorbar, (loc, align))
        return colorbar
