...
class TestCollectAndReplaceFonts:
    ...
    def test_replace_fonts_with_required_attributes(self, monkeypatch):
        ...
        with patch('ultraplot.internals.fonts.ttfFontProperty', return_value=mock_font_prop) as mock_ttf, \
             patch('ultraplot.internals.fonts.findfont', return_value='new_font_path') as mock_findfont:
    ...
    def test_replace_fonts_empty_regular_dict(self):
        ...
        with patch('ultraplot.internals.fonts.ttfFontProperty') as mock_ttf, \
